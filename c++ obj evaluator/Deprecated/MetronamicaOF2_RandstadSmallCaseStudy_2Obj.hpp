...
class MetronamicaOF2RandstadSmallCaseStudy2Obj : public ObjectivesAndConstraintsBase
{
...
public:
    MetronamicaOF2RandstadSmallCaseStudy2Obj(boost::filesystem::path & metro_exe,
        ...
        :   num_objectives(2),
          ...
          prob_defs(new ProblemDefinitions(real_lowerbounds, max_dv_values,  int_lowerbounds, int_upperbounds, minimise_or_maximise, num_constraints)),
    ...
    ~MetronamicaOF2RandstadSmallCaseStudy2Obj()
    {
